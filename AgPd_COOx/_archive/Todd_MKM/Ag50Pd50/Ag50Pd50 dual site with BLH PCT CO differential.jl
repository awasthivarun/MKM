...
function controlFitting(global_opt_iter, local_opt_iter, priors, bounds)
    ...
    function simulateMacrokineticObservables(dG0_CO_g_to_CO_ref, dG0_OH_aq_to_OH_S1_ref, dG0_OH_aq_to_OH_S2_ref, mu, beta_bi, E_array, P_CO_array, a_OH_array, orderType)
                ...
                for j = 1:length(P_CO_array)
                    for k = 1:length(E_array)
                        ...
                        function f!(fvec,x)
                            ...
                            driving_OH_S1 = (K_OH_S1_0 * a_OH_array[i])
                            driving_OH_S2 = (K_OH_S2_0 * a_OH_array[i])
                ...
                for j = 1:length(a_OH_array)
                    for k = 1:length(E_array)
                        ...
                        function f!(fvec,x)
                            ...
                            driving_OH_S1 = (K_OH_S1_0 * a_OH_array[j])
                            driving_OH_S2 = (K_OH_S2_0 * a_OH_array[j])
    ...
    function getNegLogLikelihood(params)
        ...
        model_output = simulateMacrokineticObservables(dG0_CO_g_to_CO_ref, dG0_OH_aq_to_OH_S1_ref, dG0_OH_aq_to_OH_S2_ref, mu, beta_bi, expt_rhe_potential, P_CO_array, a_OH_array, "CO order")
        model_output_OH_order = simulateMacrokineticObservables(dG0_CO_g_to_CO_ref, dG0_OH_aq_to_OH_S1_ref, dG0_OH_aq_to_OH_S2_ref, mu, beta_bi, expt_she_potential, P_CO_array, a_OH_array, "OH order")
    ...
    function runOptimization(objective)
        ...
        # bnds
        bnds = (dG0_CO_g_to_CO_ref_bounds, dG0_OH_aq_to_OH_S1_ref_bounds, dG0_OH_aq_to_OH_S2_ref_bounds, mu_bounds, beta_bi_bounds)
    ...
    function simulateWithFittedParams(fitted_params)
        ...
        alpha_and_CO_order_simulatedOutput = simulateMacrokineticObservables(dG0_CO_g_to_CO_ref, dG0_OH_aq_to_OH_S1_ref, dG0_OH_aq_to_OH_S2_ref, mu, beta_bi, E_array_simulated, P_CO_array, a_OH_array, "CO order")

        OH_order_simulatedOutput = simulateMacrokineticObservables(dG0_CO_g_to_CO_ref, dG0_OH_aq_to_OH_S1_ref, dG0_OH_aq_to_OH_S2_ref, mu, beta_bi, E_array_OH_simulated, P_CO_array, a_OH_array, "OH order")
    ...
    function getChiSquared(fitted_params)
        ...
        alpha_and_CO_order_chi_sq = simulateMacrokineticObservables(dG0_CO_g_to_CO_ref, dG0_OH_aq_to_OH_S1_ref, dG0_OH_aq_to_OH_S2_ref, mu, beta_bi, expt_rhe_potential, P_CO_array, a_OH_array, "CO order")

        OH_order_chi_sq = simulateMacrokineticObservables(dG0_CO_g_to_CO_ref, dG0_OH_aq_to_OH_S1_ref, dG0_OH_aq_to_OH_S2_ref, mu, beta_bi, expt_she_potential, P_CO_array, a_OH_array, "OH order")
    ...
    println()
    XLSX.openxlsx("Ag50Pd50_dual_site_BLH_PCT_CO_differential_coverages_rates.xlsx", mode = "rw") do f
    ...
    XLSX.openxlsx("Ag50Pd50_dual_site_BLH_PCT_CO_differential_observables.xlsx", mode = "rw") do f
        sheet = f[1]
        sheet["A1"] = "Model potential (V vs RHE)"
        sheet["A2",dim=1] = E_array_simulated
        sheet["B1"] = "Experimental potential (V vs RHE)"
        ...
        sheet["CG1"] = "Parameter fits"
        sheet["CG2",dim=1] = fitted_params
        sheet["CH1"] = "Std Error from Finite Difference"
        sheet["CH2"] = std_error
        sheet["CI1"] = "Model potential (V vs SHE)"
        sheet["CI2",dim=1] = E_array_OH_simulated
    end
    ### Write the optimization trajectory here
    XLSX.openxlsx("Ag50Pd50_dual_site_BLH_PCT_CO_differential_local_minima.xlsx", mode = "rw") do f
        sheet = f[1]
        sheet["A1"] = "dG_CO"
        sheet["B1"] = "dG_OH_S1"
        sheet["C1"] = "dG_OH_S2"
