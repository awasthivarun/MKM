...
function controlFitting(global_opt_iter, local_opt_iter, priors, bounds)
    ...
    println()
    XLSX.openxlsx("Ag90Pd10_dual_site_BLH_PCT_CO_differential_coverages_rates.xlsx", mode = "rw") do f
    ...
    XLSX.openxlsx("Ag90Pd10_dual_site_BLH_PCT_CO_differential_observables.xlsx", mode = "rw") do f
        sheet = f[1]
        sheet["A1"] = "Model potential (V vs RHE)"
        sheet["A2",dim=1] = E_array_simulated
        sheet["B1"] = "Experimental potential (V vs RHE)"
    ...
    XLSX.openxlsx("Ag90Pd10_dual_site_BLH_PCT_CO_differential_local_minima.xlsx", mode = "rw") do f
        sheet = f[1]
        sheet["A1"] = "dG_CO"
        sheet["B1"] = "dG_OH_S1"
        sheet["C1"] = "dG_OH_S2"
