...
function controlFitting(global_opt_iter, local_opt_iter, priors, bounds)
    ...
    function simulateMacrokineticObservables(dG0_CO_g_to_CO_ref, dG0_OH_aq_to_OH_S1_ref, dG0_OH_aq_to_OH_S2_ref, E_array, P_CO_array, a_OH_array, orderType)
    ...
    function getNegLogLikelihood(params)
        ...
        model_output = simulateMacrokineticObservables(dG0_CO_g_to_CO_ref, dG0_OH_aq_to_OH_S1_ref, dG0_OH_aq_to_OH_S2_ref, expt_rhe_potential, P_CO_array, a_OH_array, "CO order")
        model_output_OH_order = simulateMacrokineticObservables(dG0_CO_g_to_CO_ref, dG0_OH_aq_to_OH_S1_ref, dG0_OH_aq_to_OH_S2_ref, expt_she_potential, P_CO_array, a_OH_array, "OH order")
    ...
    function runOptimization(objective)
        ...
        # bnds
        bnds = (dG0_CO_g_to_CO_ref_bounds, dG0_OH_aq_to_OH_S1_ref_bounds, dG0_OH_aq_to_OH_S2_ref_bounds)
    ...
    function simulateWithFittedParams(fitted_params)
        ...
        alpha_and_CO_order_simulatedOutput = simulateMacrokineticObservables(dG0_CO_g_to_CO_ref, dG0_OH_aq_to_OH_S1_ref, dG0_OH_aq_to_OH_S2_ref, E_array_simulated, P_CO_array, a_OH_array, "CO order")

        OH_order_simulatedOutput = simulateMacrokineticObservables(dG0_CO_g_to_CO_ref, dG0_OH_aq_to_OH_S1_ref, dG0_OH_aq_to_OH_S2_ref, E_array_OH_simulated, P_CO_array, a_OH_array, "OH order")
    ...
    function getChiSquared(fitted_params)
        ...
        alpha_and_CO_order_chi_sq = simulateMacrokineticObservables(dG0_CO_g_to_CO_ref, dG0_OH_aq_to_OH_S1_ref, dG0_OH_aq_to_OH_S2_ref, expt_rhe_potential, P_CO_array, a_OH_array, "CO order")

        OH_order_chi_sq = simulateMacrokineticObservables(dG0_CO_g_to_CO_ref, dG0_OH_aq_to_OH_S1_ref, dG0_OH_aq_to_OH_S2_ref, expt_she_potential, P_CO_array, a_OH_array, "OH order")
    ...
    println()
    XLSX.openxlsx("Ag75Pd25_dual_site_BLH_CO_differential_coverages_rates.xlsx", mode = "rw") do f
    ...
    XLSX.openxlsx("Ag75Pd25_dual_site_BLH_CO_differential_observables.xlsx", mode = "rw") do f
        sheet = f[1]
        sheet["A1"] = "Model potential (V vs RHE)"
        sheet["A2",dim=1] = E_array_simulated
        sheet["B1"] = "Experimental potential (V vs RHE)"
        ...
        sheet["CE1"] = "Parameter fits"
        sheet["CE2",dim=1] = fitted_params
        sheet["CF1"] = "Std Error from Finite Difference"
        sheet["CF2"] = std_error
        sheet["CG1"] = "Model potential (V vs SHE)"
        sheet["CG2",dim=1] = E_array_OH_simulated
    end
    ### Write the optimization trajectory here
    XLSX.openxlsx("Ag75Pd25_dual_site_BLH_CO_differential_local_minima.xlsx", mode = "rw") do f
        sheet = f[1]
        sheet["A1"] = "dG_CO"
        sheet["B1"] = "dG_OH_S1"
        sheet["C1"] = "dG_OH_S2"
